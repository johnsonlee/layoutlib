 ...
 *
 * Because there's no custom view support, the int to resource name is all dynamic instead of
 * looking up in the R.java class that was compiled.
 *
 */
public class ProjectCallback extends LayoutlibCallback {
    ...
    public boolean supports(int ideFeature) {
        return ideFeature < Bridge.API_CURRENT;
    }
    ...
    public ParserFactory getParserFactory() {
        return new ParserFactory() {
            @Override
            public XmlPullParser createParser(String debugName) {
