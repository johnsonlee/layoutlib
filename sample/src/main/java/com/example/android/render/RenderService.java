...
public class RenderService {
    ...
    private final LayoutlibCallback mProjectCallback;
     ...
     *
     * @param overrideBgColor
     *         the overriding background color to be used in the rendering,
     ...
     *         true if the rendering should include system bars etc.
     * @return this (such that chains of setters can be stringed together)
     */
     ...
     * as an image
     *
     * @param drawableResourceValue
     *         the drawable resource value to be rendered, or null
    ...
    public BufferedImage renderDrawable(ResourceValue drawableResourceValue) {
        ...
        DrawableParams params = new DrawableParams(drawableResourceValue, this,
                new HardwareConfig(mWidth, mHeight, mConfig.getDensityQualifier().getValue(), mXdpi, mYdpi, ScreenSize.NORMAL, ScreenOrientation.PORTRAIT, ScreenRound.ROUND, true),
